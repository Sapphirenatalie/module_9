...
write = get_advanced_writer('example.txt')
write('Это строчка', ['А', 'это', 'уже', 'число', 75, 'в', 'списке'])
...
first_ball = MysticBall('Да', 'Без сомнений', 'Думаю нет', 'Спросите снова', 'Спросите позже',
                        'Шансы хорошие', 'Мало шансов', 'Точно да', 'Очень вероятно', 'Не могу сказать',
