...
print(f'проверка на строковые значения и значения {bool} с изменением длины списка '
      f'после удаления значений, не относящимся к {int}, {float}')

print(apply_all_func([6, '20.1', '15', 'True'], max, min, len, sorted, sum))
print(apply_all_func([6, '20.5', 15.7, '9', False], max, min, len, sorted, sum))
